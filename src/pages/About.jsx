...
export default function About() {
  return (
    <main className="section">
      <SEO title="About Us | Bugnot Painting and Renovation" description="Ottawa-based painting & renovation specialists delivering expert craftsmanship, premium materials, and a white-glove customer experience." />
      <div className="container narrow">
        <Reveal as="header" className="page-header">
          <h1 className="page-title">About Bugnot Painting and Renovation</h1>
        ...
        <Reveal as="div" className="prose" delay={100}>
          <p>Founded in Ottawa, Bugnot Painting and Renovation brings together craftsmanship, premium materials, and a commitment to customer care. Whether it's a flawless paint job or a complete home renovation, we believe exceptional results start long before the first coat or first swing of the hammer — through meticulous planning, clean job sites, and clear communication.</p>
